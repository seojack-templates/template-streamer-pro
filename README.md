# template-streamer-pro

A standalone SEOJack website template. Lean Next.js 16 app (App Router, React 19,
scoped CSS — no Tailwind/Convex/Clerk).

- **Live:** https://streamer-pro.templates.seojack.website
- **Registry id:** `tpl_streamer_pro`
- **Showcased on:** https://seojack.net/templates/tpl_streamer_pro
...
| `app/styles.ts` | one scoped CSS literal (every selector prefixed `.streamer-pro-demo`) |
...
Own GitHub repo (`seojack-templates/template-streamer-pro`) + own Vercel project,
production domain `https://streamer-pro.templates.seojack.website`. See `docs/templates-github-org.md`.